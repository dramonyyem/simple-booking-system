...
export default function Page() {
    ...
    return (
        <CustomLayout>
            <div 
            className="relative flex flex-col mx-auto w-7/10 mt-2 text-gray-700 border-1 border-gray-300 bg-white shadow-md rounded-xl bg-clip-border p-3">
            <div className="flex justify-between">
                <div>
                Profile
                </div>
                <div> 
                <button className="bg-red-500 text-white py-1 px-2 rounded-lg" onClick={handleLogout}>
                    Log out
                </button>
                </div>
