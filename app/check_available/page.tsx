        ...
        <CustomLayout>
            <div className="my-4 flex justify-center items-center">
                <div className="bg-white border-1 border-gray-purple p-5 rounded-lg shadow-fuchsia-200 shadow-lg">
                    ...
                    <form className="w-[600px] flex justify-center items-center" onSubmit={handleSubmit}>
                        <div>
                            <DatePicker className="w-[450px] " 
                                label="Booking date"   
                                value={date}
                                onChange={setDate}
                                minValue={todayValue}  
                        ...
                        <div className="">
                            <button className='p-4 ml-1 bg-purple-500 rounded-lg w-[140px]' type="submit">
                                CHECK
                            </button>
                        </div>  
                    </form>
                        ...
                        <div>
                            ...
                            {available.length > 0 ? (
                               <div className="grid grid-cols-3 gap-4">
                                    {available.map((t) => (
                                        <a key={t.key} className="border rounded-lg p-2 border-amber-300 text-center hover:bg-purple-600 hover:text-white cursor-pointer" href="/auth/login">
                                        {t.label}
                                        </a>
                                    ))}
                                </div>
